...
uint32 StX         = 0; // position along the horizonal axis 0 to 20
uint32 StY         = 0; // position along the vertical axis 0 to 15
uint16 StTextColor = ST7735_YELLOW;
...
#define TFT_CS      (*((volatile uint32 *)0x40004020))
#define TFT_CS_LOW  0 // CS normally controlled by hardware
#define TFT_CS_HIGH 0x08
#define DC          (*((volatile uint32 *)0x40004100))
#define DC_COMMAND  0
#define DC_DATA     0x40
#define RESET       (*((volatile uint32 *)0x40004200))
#define RESET_LOW   0
...
static const uint8_t Font[] = {
    ...
    0x08, 0x08, 0x00, 0x00, 0x60, 0x60, 0x00, 0x20, 0x10, 0x08, 0x04, 0x02, 0x3E, 0x51, 0x49, 0x45, 0x3E, // 0
    ...
    0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x40, 0x34, 0x00, 0x00, 0x00, 0x08, 0x14, 0x22, 0x41, 0x14, 0x14, 0x14, 0x14,
    0x14, 0x00, 0x41, 0x22, 0x14, 0x08, 0x02, 0x01, 0x59, 0x09, 0x06, 0x3E, 0x41, 0x5D, 0x59, 0x4E, 0x7C, 0x12, 0x11,
    0x12, 0x7C,                   // A
    ...
    0x00, 0x7F, 0x41, 0x41, 0x41, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x41, 0x41, 0x41, 0x7F, 0x04, 0x02, 0x01, 0x02,
    0x04, 0x40, 0x40, 0x40, 0x40, 0x40, 0x00, 0x03, 0x07, 0x08, 0x00, 0x20, 0x54, 0x54, 0x78, 0x40, // a
    ...
    ,
};
...
CFE_Status_t ST7735_Init(IO_TransSpiConfig_t *spiConfig)
{
...
void static SST7735_WriteCommand(uint8_t c)
{
    // TODO: Write DC to COMMAND (low?)
    int32 bytesWritten = IO_TransSPIWrite(DISPLAY_SpiFd, &c, sizeof(c));
    if (bytesWritten <= 0)
    {
        // ERROR
...
void static SST7735_WriteData(uint8_t c)
{
    // TODO: Write DC to DATA (high?)
    int32 bytesWritten = IO_TransSPIWrite(DISPLAY_SpiFd, &c, sizeof(c));
    if (bytesWritten <= 0)
    {
        // ERROR
...
// Rather than a bazillion SST7735_WriteCommand() and SST7735_WriteData() calls, screen
...
static const uint8_t Bcmd[]       = {     // Initialization commands for 7735B screens
    ...
    0x11, 0x15, ST7735_GMCTRP1, 16, // 13: Magical unicorn dust, 16 args, no delay:
...
void static commandList(const uint8_t *addr)
{
    ...
    while (numCommands--)
    {                                    // For each command...
        SST7735_WriteCommand(*(addr++)); //   Read, issue command
        numArgs = *(addr++);             //   Number of args to follow
        ms      = numArgs & DELAY;       //   If hibit set, delay follows args
        numArgs &= ~DELAY;               //   Mask out delay bit
        while (numArgs--)
        {                                 //   For each argument...
            SST7735_WriteData(*(addr++)); //     Read, issue argument
        }
...
void ST7735_InitR(enum initRFlags option)
{
    ...
    {
        SST7735_WriteCommand(ST7735_MADCTL);
        SST7735_WriteData(0xC0);
    }
    TabColor = option;
    ST7735_SetCursor(0, 0);
    StTextColor = ST7735_YELLOW;
...
void static setAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1)
{
    ...
    SST7735_WriteCommand(ST7735_CASET); // Column addr set
    SST7735_WriteData(0x00);
    SST7735_WriteData(x0 + ColStart); // XSTART
    SST7735_WriteData(0x00);
    SST7735_WriteData(x1 + ColStart); // XEND

    SST7735_WriteCommand(ST7735_RASET); // Row addr set
    SST7735_WriteData(0x00);
    SST7735_WriteData(y0 + RowStart); // YSTART
    SST7735_WriteData(0x00);
    SST7735_WriteData(y1 + RowStart); // YEND

    SST7735_WriteCommand(ST7735_RAMWR); // write to RAM
}

// Send two bytes of data, most significant byte first
// Requires 2 bytes of transmission
void static pushColor(uint16 color)
{
    SST7735_WriteData((uint8_t)(color >> 8));
    SST7735_WriteData((uint8_t)color);
}
...
// Output: none
void ST7735_DrawPixel(int16_t x, int16_t y, uint16 color)
{
...
//        color 16-bit color, which can be produced by ST7735_Color565()
// Output: none
void ST7735_DrawFastVLine(int16_t x, int16_t y, int16_t h, uint16 color)
{
    ...
    while (h--)
    {
        SST7735_WriteData(hi);
        SST7735_WriteData(lo);
    }
}
...
//        color 16-bit color, which can be produced by ST7735_Color565()
// Output: none
void ST7735_DrawFastHLine(int16_t x, int16_t y, int16_t w, uint16 color)
{
    uint8_t hi = color >> 8, lo = color;
...
//        color 16-bit color, which can be produced by ST7735_Color565()
// Output: none
void ST7735_FillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16 color)
{
    uint8_t hi = color >> 8, lo = color;
...
//        b blue value
// Output: 16-bit color
uint16 ST7735_Color565(uint8_t r, uint8_t g, uint8_t b)
{
...
uint16 ST7735_SwapColor(uint16 x)
{
...
void ST7735_DrawBitmap(int16_t x, int16_t y, const uint16 *image, int16_t w, int16_t h)
{
    int16_t skipC = 0; // non-zero if columns need to be skipped due to clipping
    int16_t originalWidth =
        w; // save this value; even if not all columns fit on the screen, the image is still this width in ROM
    int i = w * (h - 1);
    ...
    for (y = 0; y < h; y = y + 1)
    {
        ...
        {
            // send the top 8 bits
            SST7735_WriteData((uint8_t)(image[i] >> 8));
            // send the bottom 8 bits
            SST7735_WriteData((uint8_t)image[i]);
...
uint32 ST7735_DrawString(uint16 x, uint16 y, const char *pt, int16_t textColor)
{
    uint32 count = 0;
    if (y > 15)
        return 0;
...
// outputs: none
void ST7735_SetCursor(uint32 newX, uint32 newY)
{
    if ((newX > 20) || (newY > 15))
    {           // bad input
        return; // do nothing
...
void ST7735_SetRotation(uint8_t m)
{
    ...
    switch (Rotation)
    {
        case 0:
            ...
            {
                SST7735_WriteData(MADCTL_MX | MADCTL_MY | MADCTL_RGB);
            }
            else
            {
                SST7735_WriteData(MADCTL_MX | MADCTL_MY | MADCTL_BGR);
            }
        ...
        case 1:
            if (TabColor == INITR_BLACKTAB)
            {
                SST7735_WriteData(MADCTL_MY | MADCTL_MV | MADCTL_RGB);
            }
            else
            {
                SST7735_WriteData(MADCTL_MY | MADCTL_MV | MADCTL_BGR);
            }
        ...
        case 2:
            if (TabColor == INITR_BLACKTAB)
            {
                SST7735_WriteData(MADCTL_RGB);
            }
            else
            {
                SST7735_WriteData(MADCTL_BGR);
            }
            _width  = ST7735_TFTWIDTH;
            _height = ST7735_TFTHEIGHT;
            break;
        case 3:
            if (TabColor == INITR_BLACKTAB)
            {
                SST7735_WriteData(MADCTL_MX | MADCTL_MV | MADCTL_RGB);
            }
            else
            {
                SST7735_WriteData(MADCTL_MX | MADCTL_MV | MADCTL_BGR);
            }
            _width  = ST7735_TFTHEIGHT;
            _height = ST7735_TFTWIDTH;
            break;
...
void ST7735_InvertDisplay(int i)
{
    if (i)
    {
        SST7735_WriteCommand(ST7735_INVON);
